...
/**
 * Test case for class HV\AnnuaireHv\Controller\OrganismeController.
 *
...
class OrganismeControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \HV\AnnuaireHv\Controller\OrganismeController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('HV\\AnnuaireHv\\Controller\\OrganismeController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllOrganismesFromRepositoryAndAssignsThemToView()
	{
		...
		$organismeRepository = $this->getMock('HV\\AnnuaireHv\\Domain\\Repository\\OrganismeRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$organisme = new \HV\AnnuaireHv\Domain\Model\Organisme();
